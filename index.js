...
const main = async () => {
  const endpoint = "https://ideathon-faceapi.cognitiveservices.azure.com/" ?? "<endpoint>";
  const apikey = "3EaRh7iDUk1sysvtLNJjY3wEfOwNFvytneKVoszsVjfFaineiyS3JQQJ99BBAC3pKaRXJ3w3AAAKACOG0H8s" ?? "<apikey>";
